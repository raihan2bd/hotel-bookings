...
// ReservationSummery displays the reservation summary page
...
// ChooseRoom display available rooms
...
// Book Room takes Url parameters, builds a sessional variable, and take user to make res screen
func (m *Repoository) BookRoom(w http.ResponseWriter, r *http.Request) {
